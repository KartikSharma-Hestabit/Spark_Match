...
class DiscoverViewModel @Inject constructor() : ViewModel() {
    ...
    private val _cardsList: MutableStateFlow<List<CardData>> = MutableStateFlow(
        mutableListOf(
            CardData(1, "Camila Snow", 23, "Marketer", R.drawable.img_1),
            CardData(2, "Bred Jackson", 25, "Photographer", R.drawable.img_2),
            CardData(3, "Jessica Parker", 24, "Model", R.drawable.img_3),
            CardData(1, "Camila Snow", 23, "Marketer", R.drawable.img_1),
            CardData(2, "Bred Jackson", 25, "Photographer", R.drawable.img_2),
            CardData(3, "Jessica Parker", 24, "Model", R.drawable.img_3),
            CardData(1, "Camila Snow", 23, "Marketer", R.drawable.img_1),
