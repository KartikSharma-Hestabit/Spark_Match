            ...
            Card(
                ...
                Column(modifier = Modifier.padding(start = 40.dp, top = 80.dp, end = 40.dp, bottom = 40.dp)) {
                    ...
                    Column {
                        Row(
                            ...
                            Column {
                                ...
                                Text(
                                    text = profile.profession.ifEmpty { "Professional" },
                                    fontFamily = modernist,
                    ...
                    Column {
                        Row(
                            ...
                            Column {
                                ...
                                Text(
                                    text = profile.location.ifEmpty { "Chicago, IL United States" },
                                    fontFamily = modernist,
                                    fontWeight = FontWeight.Normal,
                                    fontSize = 14.sp
                                )
                    ...
                    Column {
                        ...
                        Text(
                            text = profile.about.ifEmpty {
                                "My name is ${profile.firstName} ${profile.lastName} and I enjoy meeting new people and finding ways to help them have an uplifting experience. I enjoy reading.."
                            },
                            fontFamily = modernist,
                            fontWeight = FontWeight.Normal,
                            fontSize = 14.sp
                    ...
                    Column {
                        ...
                        FlowRow(
                            ...
                            // Show user's passions if available, otherwise use placeholder interests
                            if (profile.passions.isNotEmpty()) {
                                profile.passions.forEach { passion ->
                                    InterestChip(
                                        text = passion,
                                        isSelected = selectedInterests.contains(passion)
                                    )
                                }
                            } else {
                    ...
                    Column {
                        ...
                        LazyVerticalStaggeredGrid(
                            ...
                            // Use gallery images if available, otherwise use placeholder images
                            if (profile.galleryImages.isNotEmpty()) {
                                items(profile.galleryImages) { imageUrl ->
                                    Card(
                                ...
                                // Use placeholder images if no gallery images are available
